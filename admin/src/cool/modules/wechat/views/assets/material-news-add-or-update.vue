	...
	<div v-show="visible">
		<div class="flex">
			...
			>
				<el-form-item label="标题" prop="title">
					<el-input v-model="articles[selectedIndex].title" placeholder="标题" />
				</el-form-item>
				...
				<el-form-item label="摘要" prop="digest">
					<el-input v-model="articles[selectedIndex].digest" placeholder="摘要" />
				</el-form-item>
				...
				<el-row>
					<el-col :span="9">
						<el-form-item label="作者" prop="author">
							<el-input v-model="articles[selectedIndex].author" placeholder="作者" />
						</el-form-item>
					</el-col>
					<el-col :span="5">
						<el-form-item label="显示封面" prop="showCoverPic">
							<el-switch v-model="articles[selectedIndex].showCoverPic" />
						</el-form-item>
					</el-col>
					<el-col :span="5">
						<el-form-item label="允许评论" prop="needOpenComment">
							<el-switch v-model="articles[selectedIndex].needOpenComment" />
						</el-form-item>
					</el-col>
					<el-col :span="5">
						<el-form-item label="仅粉丝可评论" prop="onlyFansCanComment">
							<el-switch v-model="articles[selectedIndex].onlyFansCanComment" />
						</el-form-item>
					</el-col>
				</el-row>
		...
		<div class="dialog-footer">
			...
			<el-button type="primary" @click="dataFormSubmit()" :disabled="uploading">{{
				mediaId ? "修改此篇" : "全部提交（共" + articles.length + "篇）"
			}}</el-button>
		</div>
		<assets-selector
	...
	data() {
		return {
			...
			dataRule: {
				...
				contentSourceUrl: [{ required: true, message: "原文地址不得为空", trigger: "blur" }]
			}
		};
	},
	methods: {
