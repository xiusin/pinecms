						...
						>
							<div class="card-preview">
								...
								>
									...
									<el-image class="article-thumb" :src="article.thumbUrl" />
								</a>
							</div>
							<div class="card-footer">
								...
								<div class="flex justify-between align-center" v-show="!selectMode">
									<el-button
										...
										v-clipboard:copy="item.mediaId"
										v-clipboard:success="onCopySuccess"
										v-clipboard:error="onCopyError"
										>复制media_id</el-button
									>
									<el-button
										size="mini"
										type="text"
										icon="el-icon-edit"
										@click="addOrUpdateHandle(item)"
										>编辑</el-button
									>
									<el-button
										size="mini"
										type="text"
										icon="el-icon-delete"
										@click="deleteHandle(item.mediaId)"
										>删除</el-button
									>
								</div>
							</div>
...
<script>
import AddOrUpdate from "./material-news-add-or-update.vue";
export default {
	name: "material-news",
	components: {
		AddOrUpdate
