<template>
	...
	>
		...
		<span slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click="dataFormSubmit()" :disabled="submitting">{{
				submitting ? "保存中..." : "确定"
			}}</el-button>
		</span>
	</cl-dialog>
		...
		dataFormSubmit() {
			...
			this.$http({
				url: this.$http.adornUrl(
					`/manage/wxUserTags/${
						this.mode === "tagging" ? "batchTagging" : "batchUnTagging"
					}`
				),
				method: "post",
