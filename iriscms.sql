...
# Created: March 8, 2020 at 11:11:58 AM GMT+8
...
CREATE TABLE `iriscms_attachments` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='附件表';
...
) ENGINE=MyISAM AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='权限菜单表';
...
INSERT INTO `iriscms_articles` (`id`, `title`, `tags`, `thumb`, `from_url`, `author`, `keywords`, `description`, `content`, `pubtime`, `catid`, `mid`, `refid`, `listorder`, `visit_count`, `status`, `created_time`, `updated_time`, `deleted_time`) VALUES 
...
INSERT INTO `iriscms_category` (`catid`, `type`, `parentid`, `catname`, `description`, `model_id`, `manager_content_router`, `edit_content_router`, `add_content_router`, `url`, `listorder`, `ismenu`, `index_tpl`, `list_tpl`, `detail_tpl`, `thumb`, `tpl_prefix`, `home_tpl`, `content_tpl`) VALUES 
...
INSERT INTO `iriscms_page` (`catid`, `title`, `keywords`, `description`, `content`, `updatetime`) VALUES 
