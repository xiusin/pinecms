...
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='权限表';
...
INSERT INTO `iriscms_attachments` (`id`, `name`, `url`, `origin_name`, `size`, `upload_time`, `type`) VALUES 
	(1,'HOT4zStb14.jpg','/upload/public/20200210/HOT4zStb14.jpg','64673db6d9.jpg',604762,'2020-02-10 17:09:21','img'),
...
INSERT INTO `iriscms_document_model` (`id`, `name`, `table`, `enabled`, `is_system`, `model_type`, `fe_tpl_index`, `fe_tpl_list`, `fe_tpl_detail`, `deleted_at`, `field_show_in_list`, `formatters`, `execed`) VALUES 
	(5,'系统模型','articles',1,0,0,'resources/views/backend/admin_editpwd.html','resources/views/backend/category_edit.html','resources/views/backend/index_index.html',NULL,'{"content":{"show":false,"formatter":""},"description":{"show":false,"formatter":""},"from_url":{"show":false,"formatter":""},"from_website":{"show":true,"formatter":""},"images":{"show":false,"formatter":""},"keywords":{"show":true,"formatter":""},"published":{"show":false,"formatter":""},"tags":{"show":false,"formatter":""},"thumb":{"show":false,"formatter":""},"title":{"show":true,"formatter":""}}','function titleFormatter(title) {return title + "111";};',0);
...
INSERT INTO `iriscms_document_model_dsl` (`id`, `mid`, `form_name`, `table_field`, `html`, `required`, `datasource`, `required_tips`, `validator`, `deleted_at`, `field_type`, `default`) VALUES 
	(510,5,'标题','title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',1,'','','',NULL,1,''),
	(511,5,'关键字','keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(512,5,'描述','description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="height:80px; width: 300px;"  multiline />',0,'','','',NULL,2,''),
	(513,5,'封面','thumb','<images />',1,'','封面图片必须上传','',NULL,11,''),
	(514,5,'内容','content','<editor />',1,'','','',NULL,3,''),
	(515,5,'来源','from_website','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(516,5,'来源地址','from_url','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','\'url\'',NULL,1,''),
	(517,5,'标签','tags','<tags />',0,'','','',NULL,15,''),
	(518,5,'是否发布','published','<input class="easyui-radiobutton" {{attr}} value="{{value}}" {{default}} />',0,'["是", "否"]','','',NULL,7,'是'),
	(519,5,'图集','images','<mul-images />',1,'','','',NULL,12,'');
