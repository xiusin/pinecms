...
-- ----------------------------
INSERT INTO `pinecms_admin` VALUES (1, 'admin', '5736a2a40f752bf2e82953702d25075b', 1, 'qmRlFL', '::1', 1474291850, 'chenchengbin92@gmail.com', '陈成彬（xiusin）');
...
INSERT INTO `pinecms_admin_role` VALUES (10, 'other', '', 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pinecms_advert
-- ----------------------------
INSERT INTO `pinecms_advert` VALUES (4, 'banner1', 6, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/p9zaDoQ1ZQ.jpg', 'http://www.baidu.com', 0, '2020-03-01 18:47:51', '2021-03-10 18:47:57', 1);
INSERT INTO `pinecms_advert` VALUES (5, 'banner2', 6, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/8DF0DlN4xQ.jpg', 'http://www.xiusin.com', 0, '2020-03-24 18:48:35', '2022-03-16 18:48:37', 1);
INSERT INTO `pinecms_advert` VALUES (6, 'banner3', 6, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/0N18qZcl6u.jpg', 'a', 0, '2020-03-01 18:49:08', '2022-03-15 18:49:12', 1);
INSERT INTO `pinecms_advert` VALUES (7, 'banner4', 6, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/BrcMqB37Cf.jpg', 'aaa', 0, '2020-03-02 18:49:42', '2023-03-22 18:49:45', 1);
INSERT INTO `pinecms_advert` VALUES (8, '长条广告', 7, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/5K2giheHM5.jpg', '', 0, '2020-03-24 18:51:40', '2022-03-30 18:51:45', 1);
INSERT INTO `pinecms_advert` VALUES (9, '方形广告1', 8, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/2nYZoj2iLI.jpg', '', 0, '2020-03-09 18:52:48', '2022-03-16 18:52:51', 1);
INSERT INTO `pinecms_advert` VALUES (10, '方形广告2', 8, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/40B5hc9v5I.jpg', '', 0, '2020-03-24 18:53:25', '2022-03-17 18:53:27', 1);
INSERT INTO `pinecms_advert` VALUES (11, '个人二维码', 10, 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/4kyS4LoTIS.png', '', 0, '2020-03-24 18:54:20', '2022-03-29 18:54:22', 1);
INSERT INTO `pinecms_advert` VALUES (12, 'asdasdad', 10, '/upload/public/20200321/Tog81s99Q2.png', '', 0, '2020-03-26 16:28:35', '2021-03-26 16:28:35', 1);
...
CREATE TABLE `pinecms_advert_space`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告位表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pinecms_advert_space
-- ----------------------------
INSERT INTO `pinecms_advert_space` VALUES (6, '首页banner');
INSERT INTO `pinecms_advert_space` VALUES (7, '首页中部位置横幅');
INSERT INTO `pinecms_advert_space` VALUES (8, '右部广告块');
INSERT INTO `pinecms_advert_space` VALUES (9, '右部底部二维码');
INSERT INTO `pinecms_advert_space` VALUES (10, '个人二维码');
...
CREATE TABLE `pinecms_articles`  (
  ...
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属栏目ID',
  `mid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '模型ID',
  `refid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '模型关联的文章ID',
  `listorder` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序值',
...
CREATE TABLE `pinecms_attachments`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 159 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '附件表' ROW_FORMAT = Dynamic;
...
INSERT INTO `pinecms_attachments` VALUES (150, 'p9zaDoQ1ZQ.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/p9zaDoQ1ZQ.jpg', '1.jpg', 105452, '2020-03-24 18:47:23', 'file');
INSERT INTO `pinecms_attachments` VALUES (151, '8DF0DlN4xQ.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/8DF0DlN4xQ.jpg', '2.jpg', 66599, '2020-03-24 18:48:23', 'file');
INSERT INTO `pinecms_attachments` VALUES (152, '0N18qZcl6u.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/0N18qZcl6u.jpg', '3.jpg', 43351, '2020-03-24 18:49:05', 'file');
INSERT INTO `pinecms_attachments` VALUES (153, 'BrcMqB37Cf.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/BrcMqB37Cf.jpg', '4.jpg', 97919, '2020-03-24 18:49:39', 'file');
INSERT INTO `pinecms_attachments` VALUES (154, '5K2giheHM5.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/5K2giheHM5.jpg', 'longad.jpg', 90292, '2020-03-24 18:51:37', 'file');
INSERT INTO `pinecms_attachments` VALUES (155, '2nYZoj2iLI.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/2nYZoj2iLI.jpg', 'ad.jpg', 155818, '2020-03-24 18:52:45', 'file');
INSERT INTO `pinecms_attachments` VALUES (156, '40B5hc9v5I.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/40B5hc9v5I.jpg', 'ad02.jpg', 116775, '2020-03-24 18:53:22', 'file');
INSERT INTO `pinecms_attachments` VALUES (157, '4kyS4LoTIS.png', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200324/4kyS4LoTIS.png', 'joinwx.png', 21736, '2020-03-24 18:54:17', 'file');
INSERT INTO `pinecms_attachments` VALUES (158, 'y2LHji2RGI.jpg', 'http://iriscms-test.oss-cn-beijing.aliyuncs.com/upload/public/20200325/y2LHji2RGI.jpg', '3.jpg', 43351, '2020-03-25 16:58:59', 'file');
...
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '内容分类表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pinecms_category
-- ----------------------------
INSERT INTO `pinecms_category` VALUES (1, 0, 0, '随意速记', '发布杂乱文章内容', 1, '', '', '', '', 1, 1, '', '', '', '', NULL, NULL, NULL, 'suiyisuji');
INSERT INTO `pinecms_category` VALUES (2, 0, 0, '最新动态', '记录项目最新情况', 1, '', '', '', '', 2, 1, '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO `pinecms_category` VALUES (3, 0, 1, '项目速记', '关于项目的速记内容', 1, '', '', '', '', 0, 1, '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO `pinecms_category` VALUES (4, 0, 1, '工作速记', '工作内容相关速记', 1, '', '', '', '', 0, 1, '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO `pinecms_category` VALUES (5, 1, 0, '关于项目', '项目介绍页面', 0, '', '', '', '', 0, 1, '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO `pinecms_category` VALUES (6, 0, 0, '下载专区', '', 2, '', '', '', '', 0, 1, '', '', '', '', NULL, NULL, NULL, NULL);
...
CREATE TABLE `pinecms_document_model`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文档模型用于存储自定义类型的文档内容' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pinecms_document_model
-- ----------------------------
INSERT INTO `pinecms_document_model` VALUES (1, '普通文章', 'articles', 1, 1, 'resources/views/frontend/index.jet', '', '', NULL, '{\"author\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"content\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"description\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"from_url\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"keywords\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"pubtime\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"tags\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"thumb\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"title\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"visit_count\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"}}', '*', ' ', 0);
INSERT INTO `pinecms_document_model` VALUES (2, '下载模型', 'download', 1, 0, '', 'list_download.jet', 'page.jet', NULL, '{\"content\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"description\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"downs\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"ext\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"files\":{\"show\":true,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"keywords\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"size\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"},\"title\":{\"show\":false,\"search\":0,\"fe_search\":false,\"formatter\":\"\"}}', '*', ' ', 0);
INSERT INTO `pinecms_document_model` VALUES (3, '测试模型', 'test_test', 1, 1, '', 'list_article.jet', 'list_download.jet', NULL, '', '', '', 0);
...
CREATE TABLE `pinecms_document_model_dsl`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 194 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '模型表单定义表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pinecms_document_model_dsl
-- ----------------------------
INSERT INTO `pinecms_document_model_dsl` VALUES (1, 0, '标题', 1, 'title', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (2, 0, '关键字', 2, 'keywords', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (3, 0, '摘要', 3, 'description', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"height:80px; width: 300px;\"  multiline />', 0, '', '', '', NULL, 2, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (4, 0, '访问次数', 99, 'visit_count', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, NULL, NULL, NULL, NULL, 9, NULL);
INSERT INTO `pinecms_document_model_dsl` VALUES (5, 0, '状态', 100, 'status', '<input class=\"easyui-switchbutton\" value=\"{{value}}\" {{attr}} {{default}} />', 0, NULL, NULL, NULL, NULL, 9, NULL);
...
INSERT INTO `pinecms_document_model_dsl` VALUES (129, 1, '访问次数', 0, 'visit_count', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, NULL, NULL, NULL, NULL, 2, NULL);
INSERT INTO `pinecms_document_model_dsl` VALUES (156, 2, '标题', 1, 'title', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (157, 2, '关键字', 2, 'keywords', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (158, 2, '描述', 3, 'description', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (159, 2, '内容', 4, 'content', '<editor />', 0, '', '', '', NULL, 3, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (160, 2, '上传文件', 5, 'files', '<fileupload />', 0, '', '', '', NULL, 4, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (161, 2, '文件类型', 6, 'ext', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (162, 2, '文件大小', 7, 'size', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, '', '', '', NULL, 10, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (163, 2, '下载次数', 8, 'downs', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, '', '', '', NULL, 9, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (189, 3, '标题', 1, 'title', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (190, 3, '关键字', 2, 'keywords', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (191, 3, '摘要', 3, 'description', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"height:80px; width: 300px;\"  multiline />', 0, '', '', '', NULL, 2, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (192, 3, '访问次数', 99, 'visit_count', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, '', '', '', NULL, 9, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (193, 3, '状态', 100, 'status', '<input type=\"text\" class=\"easyui-numberbox\" value=\"{{value}}\" {{attr}} />', 0, '', '', '', NULL, 9, '');
...
INSERT INTO `pinecms_document_model_field` VALUES (4, '附件', 'varchar', '前端表现为input[file]类型,可以上传并且返回一个相对地址', '<fileupload />');
...
CREATE TABLE `pinecms_download`  (
  ...
  `ext` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件类型',
  `size` float NULL DEFAULT NULL COMMENT '文件大小',
  `downs` int(11) NULL DEFAULT NULL COMMENT '下载次数',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属栏目ID',
  `mid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '模型ID',
  `listorder` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序值',
  `visit_count` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '访问次数',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '审核状态, 前端检索条件之一',
  `created_time` datetime(0) NULL DEFAULT NULL,
  `updated_time` datetime(0) NULL DEFAULT NULL,
  `deleted_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pinecms_download` VALUES (1, 'sadas', 'dasd', 'asd', '<p>asdasdasd</p>', '[{\"title\":\"1jPeJ02eR9.gif\",\"url\":\"/upload/public/20200321/1jPeJ02eR9.gif\",\"type\":\"gif\"},{\"title\":\"ThECSqh65Q.zip\",\"url\":\"/upload/public/20200321/ThECSqh65Q.zip\",\"type\":\"zip\"}]', '11', 111, 1111, 6, 2, 0, 0, 1, '2020-03-22 12:10:40', '2020-03-22 12:14:58', NULL);
...
CREATE TABLE `pinecms_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 99 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限菜单表' ROW_FORMAT = Fixed;
...
INSERT INTO `pinecms_menu` VALUES (98, '缓存管理', 9, 'setting', 'cache', '', 0, 0, '1');
...
INSERT INTO `pinecms_setting` VALUES ('UPLOAD_ENGINE', 'local', '存储配置', 'local', '存储引擎', '{\"type\":\"combogrid\",\"options\":{\"idField\":\"key\",\"textField\":\"key\",\"fitColumns\":true,\"columns\":[[{\"field\":\"key\",\"title\":\"存储引擎\",\"width\":120}]],\"data\":[{\"key\":\"本地存储\",\"value\":\"local\"},{\"key\":\"OSS存储\",\"value\":\"oss\"}]}}', 20);
...
INSERT INTO `pinecms_setting` VALUES ('OSS_HOST', '', 'OSS存储配置', NULL, 'HOST', 'text', 19);
INSERT INTO `pinecms_setting` VALUES ('OSS_ENDPOINT', '', 'OSS存储配置', NULL, 'ENDPOINT', 'text', 17);
INSERT INTO `pinecms_setting` VALUES ('OSS_KEYID', '', 'OSS存储配置', NULL, 'KEYID', 'text', 15);
INSERT INTO `pinecms_setting` VALUES ('OSS_BUCKETNAME', '', 'OSS存储配置', NULL, 'BUCKETNAME', 'text', 18);
INSERT INTO `pinecms_setting` VALUES ('OSS_KEYSECRET', '', 'OSS存储配置', NULL, 'SECRET', 'text', 16);
