...
# Created: March 23, 2020 at 9:41:40 PM GMT+8
# Encoding: Unicode (UTF-8)
#


CREATE DATABASE IF NOT EXISTS `pinecms` DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
USE `pinecms`;
...
CREATE TABLE `pinecms_advert` (
  ...
  `link_url` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `listorder` int(11) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告表';
...
CREATE TABLE `pinecms_advert_space` (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告位表';
...
CREATE TABLE `pinecms_articles` (
  ...
  `tags` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'TAG标签',
  `thumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '缩略图',
  `from_url` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文章来源',
  `author` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '作者',
  `keywords` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关键字',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '内容摘要',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统内置模型表';
...
CREATE TABLE `pinecms_attachments` (
  ...
  `origin_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `size` int(11) DEFAULT '0',
  `upload_time` datetime DEFAULT NULL,
  `type` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='附件表';
...
CREATE TABLE `pinecms_category` (
  ...
  `manager_content_router` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `edit_content_router` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `add_content_router` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `tpl_prefix` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `home_tpl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `content_tpl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`catid`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='内容分类表';
...
CREATE TABLE `pinecms_content` (
  ...
  `pwd_type` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `pinecms_document_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文档名称',
  `table` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '对应的表名',
  `enabled` tinyint(4) DEFAULT '0' COMMENT '是否启用',
  `model_type` tinyint(4) DEFAULT '0' COMMENT '模型类型: 扩展模型 和 独立模型',
  `fe_tpl_index` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模型前端主页模板地址',
  `fe_tpl_list` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模型前端列表模板地址',
  `fe_tpl_detail` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模型前端详情模板地址',
  `deleted_at` datetime DEFAULT NULL,
  `field_show_in_list` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '在后端列表页需要展示的字段以及字段应用的formatter函数.',
  `fe_search_fields` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '*' COMMENT '前端搜索字段限制， 标签调用时查看此字段',
  `formatters` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '所有函数内容, 原样渲染到Html里',
  `execed` tinyint(4) DEFAULT '0' COMMENT '是否已经执行过改动',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文档模型用于存储自定义类型的文档内容';


CREATE TABLE `pinecms_document_model_dsl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '模型id',
  `form_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段在表单内的名称',
  `listorder` int(11) unsigned NOT NULL DEFAULT '0',
  `table_field` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `html` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '字段html',
  `required` tinyint(4) DEFAULT '0' COMMENT '是否必填',
  `datasource` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数据源, 可以让下拉选项等高级功能有数据读取的源头,具体设计可以是提供列表函数类的',
  `required_tips` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '必填(选)提醒',
  `validator` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '验证器名称或内容',
  `deleted_at` datetime DEFAULT NULL,
  `field_type` int(11) NOT NULL DEFAULT '0',
  `default` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模型表单定义表';


CREATE TABLE `pinecms_document_model_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段名称',
  `type` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段对应的数据类型',
  `desc` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段描述',
  `html` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模型表单组件定义表';
...
CREATE TABLE `pinecms_download` (
  ...
  `files` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '上传文件',
  `ext` varchar(100) DEFAULT NULL COMMENT '文件类型',
  `size` float DEFAULT NULL COMMENT '文件大小',
  `downs` int(10) DEFAULT NULL COMMENT '下载次数',
  `catid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '所属栏目ID',
  `mid` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '模型ID',
  `listorder` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '排序值',
  `visit_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '访问次数',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '审核状态, 前端检索条件之一',
  `created_time` datetime DEFAULT NULL,
  `updated_time` datetime DEFAULT NULL,
  `deleted_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pinecms_member` (
  ...
  `sale_integral` int(11) DEFAULT NULL,
...
CREATE TABLE `pinecms_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='权限菜单表';
...
CREATE TABLE `pinecms_setting` (
  ...
  `group` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `default` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `form_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
LOCK TABLES `pinecms_admin` WRITE;
ALTER TABLE `pinecms_admin` DISABLE KEYS;
INSERT INTO `pinecms_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`) VALUES 
	(1,'admin','5736a2a40f752bf2e82953702d25075b',1,'qmRlFL','::1',1474291850,'chenchengbin92@gmail.com2','陈成彬（xiusin）'),
	(11,'test','834a33db060873a7a208617930edb29a',1,'5u2G0w','::1',0,'asdasd@asdasd.com1','ccc1');
ALTER TABLE `pinecms_admin` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_admin_role` WRITE;
...
LOCK TABLES `pinecms_admin_role_priv` WRITE;
ALTER TABLE `pinecms_admin_role_priv` DISABLE KEYS;
INSERT INTO `pinecms_admin_role_priv` (`roleid`, `c`, `a`) VALUES 
	(9,'category','add'),
	(9,'category','delete'),
	(9,'category','edit'),
	(9,'category','list'),
...
INSERT INTO `pinecms_attachments` (`id`, `name`, `url`, `origin_name`, `size`, `upload_time`, `type`) VALUES 
	...
	(121,'OBXu6mIm5i.jpg','/upload/public/20200303/OBXu6mIm5i.jpg','banker.jpg',88751,'2020-03-03 11:54:04','img'),
	(122,'963rCk18MP.jpg','/upload/public/20200303/963rCk18MP.jpg','banker.jpg',88751,'2020-03-03 11:54:23','img'),
	(123,'kHvGB7UMjv.jpg','/upload/public/20200303/kHvGB7UMjv.jpg','banker.jpg',88751,'2020-03-03 11:56:01','img'),
	(124,'7I2RO0j8VU.jpg','/upload/public/20200303/7I2RO0j8VU.jpg','banker.jpg',88751,'2020-03-03 11:56:17','img'),
	(125,'CY9yw7B9G2.jpg','/upload/public/20200303/CY9yw7B9G2.jpg','banker.jpg',88751,'2020-03-03 14:36:45','img'),
	(126,'1EZ28y5M4Q.jpg','/upload/public/20200303/1EZ28y5M4Q.jpg','banker.jpg',88751,'2020-03-03 14:36:49','img'),
	(127,'zebRQfaG71.png','/upload/public/20200306/zebRQfaG71.png','appdown2.png',9820,'2020-03-06 15:59:56','img'),
	(128,'BFZ5z5e5R9.jpg','/upload/public/20200309/BFZ5z5e5R9.jpg','banker.jpg',88751,'2020-03-09 10:27:22','img'),
	(129,'3Yx7CiKeB5.jpg','/upload/public/20200309/3Yx7CiKeB5.jpg','banker.jpg',88751,'2020-03-09 10:29:37','img'),
	(130,'k0SXAg1oNW.jpg','/upload/public/20200309/k0SXAg1oNW.jpg','banker.jpg',88751,'2020-03-09 10:29:51','img'),
	(133,'CaB53Ew4oF.png','/upload/public/20200309/CaB53Ew4oF.png','ICMP.png',7404,'2020-03-09 10:41:00','img'),
	(134,'BXxEyKCP0o.png','/upload/public/20200310/BXxEyKCP0o.png','动漫.png',1028236,'2020-03-10 20:13:32','img'),
	(135,'F9CEecV0a4.png','/upload/public/20200310/F9CEecV0a4.png','动漫.png',1028236,'2020-03-10 20:21:35','img'),
	(136,'st1Cu5DfW6.png','/upload/public/20200311/st1Cu5DfW6.png','self_weixin_erweima.png',18424,'2020-03-11 21:32:10','img'),
	(137,'HXhhLGDwf8.png','/upload/public/20200312/HXhhLGDwf8.png','1.png',19521,'2020-03-12 17:13:01','img'),
	(138,'R33eGyVe0v.png','/upload/public/20200312/R33eGyVe0v.png','1.png',19521,'2020-03-12 17:13:01','img'),
	(139,'v3kPak3gS5.png','/upload/public/20200312/v3kPak3gS5.png','default_man.png',10811,'2020-03-12 17:20:28','img'),
	(140,'3wHh8hrjzZ.jpg','/upload/public/20200321/3wHh8hrjzZ.jpg','542.Carousel1-potassium-1024w-1366h@2x_ipad.jpg',7287249,'2020-03-21 12:06:58','img'),
	(141,'Tog81s99Q2.png','/upload/public/20200321/Tog81s99Q2.png','modul.png',15459,'2020-03-21 12:10:09','img'),
	(142,'u9dP9AoSmo.png','/upload/public/20200321/u9dP9AoSmo.png','cross.png',438,'2020-03-21 12:11:03','img'),
	(143,'41Q6FIwac4.gif','/upload/public/20200321/41Q6FIwac4.gif','logo.gif',3427,'2020-03-21 12:17:58','file'),
	(144,'s49kowaHVY.png','/upload/public/20200321/s49kowaHVY.png','hei_logo.png',1737,'2020-03-21 12:18:41','file'),
	(145,'RZ5138jE7i.png','/upload/public/20200321/RZ5138jE7i.png','hei_logo.png',1737,'2020-03-21 12:19:48','file'),
	(146,'fMu0Kbd99o.png','/upload/public/20200321/fMu0Kbd99o.png','hei_logo.png',1737,'2020-03-21 12:20:15','file'),
	(147,'89ac9Vv86P.png','/upload/public/20200321/89ac9Vv86P.png','modul.png',15459,'2020-03-21 12:23:17','file'),
	(148,'1jPeJ02eR9.gif','/upload/public/20200321/1jPeJ02eR9.gif','logo.gif',3427,'2020-03-21 14:07:39','file'),
	(149,'ThECSqh65Q.zip','/upload/public/20200321/ThECSqh65Q.zip','归档.zip',24543728,'2020-03-21 14:43:10','file');
ALTER TABLE `pinecms_attachments` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_category` WRITE;
ALTER TABLE `pinecms_category` DISABLE KEYS;
INSERT INTO `pinecms_category` (`catid`, `type`, `parentid`, `catname`, `description`, `model_id`, `manager_content_router`, `edit_content_router`, `add_content_router`, `url`, `listorder`, `ismenu`, `index_tpl`, `list_tpl`, `detail_tpl`, `thumb`, `tpl_prefix`, `home_tpl`, `content_tpl`) VALUES 
	(1,0,0,'随意速记','发布杂乱文章内容',1,'','','','',1,1,'','','','',NULL,NULL,NULL),
	(2,0,0,'最新动态','记录项目最新情况',1,'','','','',2,1,'','','','',NULL,NULL,NULL),
	(3,0,1,'项目速记','关于项目的速记内容',1,'','','','',0,1,'','','','',NULL,NULL,NULL),
	(4,0,1,'工作速记','工作内容相关速记',1,'','','','',0,1,'','','','',NULL,NULL,NULL),
	(5,1,0,'关于项目','项目介绍页面',0,'','','','',0,1,'','','','',NULL,NULL,NULL),
	(6,0,0,'下载专区','',2,'','','','',0,1,'','','','',NULL,NULL,NULL);
ALTER TABLE `pinecms_category` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_category_priv` WRITE;
ALTER TABLE `pinecms_category_priv` DISABLE KEYS;
ALTER TABLE `pinecms_category_priv` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_content` WRITE;
ALTER TABLE `pinecms_content` DISABLE KEYS;
ALTER TABLE `pinecms_content` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_document_model` WRITE;
ALTER TABLE `pinecms_document_model` DISABLE KEYS;
INSERT INTO `pinecms_document_model` (`id`, `name`, `table`, `enabled`, `model_type`, `fe_tpl_index`, `fe_tpl_list`, `fe_tpl_detail`, `deleted_at`, `field_show_in_list`, `fe_search_fields`, `formatters`, `execed`) VALUES 
	(1,'普通文章','articles',1,1,'resources/views/frontend/index.jet','','',NULL,'{"author":{"show":false,"search":0,"fe_search":true,"formatter":""},"content":{"show":false,"search":0,"fe_search":false,"formatter":""},"description":{"show":false,"search":0,"fe_search":false,"formatter":""},"from_url":{"show":false,"search":0,"fe_search":true,"formatter":""},"keywords":{"show":false,"search":0,"fe_search":true,"formatter":""},"pubtime":{"show":false,"search":0,"fe_search":false,"formatter":""},"tags":{"show":false,"search":0,"fe_search":true,"formatter":""},"thumb":{"show":false,"search":0,"fe_search":true,"formatter":""},"title":{"show":false,"search":0,"fe_search":false,"formatter":""}}','tags,thumb,from_url,author,keywords','function (){',0),
	(2,'下载模型','download',1,0,'','','',NULL,'{"content":{"show":false,"search":0,"formatter":""},"description":{"show":true,"search":0,"formatter":""},"downs":{"show":false,"search":0,"formatter":""},"ext":{"show":true,"search":0,"formatter":""},"files":{"show":false,"search":0,"formatter":""},"keywords":{"show":true,"search":0,"formatter":""},"size":{"show":false,"search":0,"formatter":""},"title":{"show":true,"search":0,"formatter":""}}','*','',1),
	(3,'测试模型','test_test',1,1,'','','',NULL,'','','',0);
ALTER TABLE `pinecms_document_model` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_document_model_dsl` WRITE;
ALTER TABLE `pinecms_document_model_dsl` DISABLE KEYS;
INSERT INTO `pinecms_document_model_dsl` (`id`, `mid`, `form_name`, `listorder`, `table_field`, `html`, `required`, `datasource`, `required_tips`, `validator`, `deleted_at`, `field_type`, `default`) VALUES 
	(1,0,'标题',1,'title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(2,0,'关键字',2,'keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(3,0,'摘要',3,'description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="height:80px; width: 300px;"  multiline />',0,'','','',NULL,2,''),
	(4,0,'访问次数',99,'visit_count','<input type="text" class="easyui-numberbox" value="{{value}}" {{attr}} />',0,NULL,NULL,NULL,NULL,9,NULL),
	(5,0,'状态',100,'status','<input class="easyui-switchbutton" value="{{value}}" {{attr}} {{default}} />',0,NULL,NULL,NULL,NULL,9,NULL),
	(49,1,'文章标题',1,'title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(50,1,'TAG标签',1,'tags','<tags />',0,'','','',NULL,15,''),
	(51,1,'缩略图',1,'thumb','<images />',0,'','','',NULL,11,''),
	(52,1,'文章来源',1,'from_url','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(53,1,'作者',1,'author','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(54,1,'关键字',1,'keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(55,1,'内容摘要',1,'description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="height:80px; width: 300px;"  multiline />',0,'','','',NULL,2,''),
	(56,1,'文章内容',1,'content','<editor />',1,'','','',NULL,3,''),
	(57,1,'发布时间',1,'pubtime','<input class="easyui-datetimebox" style="width:300px" value="{{value}}" {{attr}} />',0,'','','',NULL,14,''),
	(114,2,'标题',1,'title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(115,2,'关键字',2,'keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(116,2,'描述',3,'description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(117,2,'内容',4,'content','<editor />',0,'','','',NULL,3,''),
	(118,2,'上传文件',5,'files','<fileupload />',0,'','','',NULL,4,''),
	(119,2,'文件类型',6,'ext','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(120,2,'文件大小',7,'size','<input type="text" class="easyui-numberbox" value="{{value}}" {{attr}} />',0,'','','',NULL,10,''),
	(121,2,'下载次数',8,'downs','<input type="text" class="easyui-numberbox" value="{{value}}" {{attr}} />',0,'','','',NULL,9,''),
	(124,3,'标题',1,'title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(125,3,'关键字',2,'keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(126,3,'摘要',3,'description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="height:80px; width: 300px;"  multiline />',0,'','','',NULL,2,''),
	(127,3,'访问次数',99,'visit_count','<input type="text" class="easyui-numberbox" value="{{value}}" {{attr}} />',0,'','','',NULL,9,''),
	(128,3,'状态',100,'status','<input type="text" class="easyui-numberbox" value="{{value}}" {{attr}} />',0,'','','',NULL,9,'');
ALTER TABLE `pinecms_document_model_dsl` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_document_model_field` WRITE;
ALTER TABLE `pinecms_document_model_field` DISABLE KEYS;
INSERT INTO `pinecms_document_model_field` (`id`, `name`, `type`, `desc`, `html`) VALUES 
	...
	(4,'附件','varchar','前端表现为input[file]类型,可以上传并且返回一个相对地址','<fileupload />'),
...
ALTER TABLE `pinecms_document_model_field` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_download` WRITE;
ALTER TABLE `pinecms_download` DISABLE KEYS;
INSERT INTO `pinecms_download` (`id`, `title`, `keywords`, `description`, `content`, `files`, `ext`, `size`, `downs`, `catid`, `mid`, `listorder`, `visit_count`, `status`, `created_time`, `updated_time`, `deleted_time`) VALUES 
	(1,'sadas','dasd','asd','<p>asdasdasd</p>','[{"title":"1jPeJ02eR9.gif","url":"/upload/public/20200321/1jPeJ02eR9.gif","type":"gif"},{"title":"ThECSqh65Q.zip","url":"/upload/public/20200321/ThECSqh65Q.zip","type":"zip"}]','11',111,1111,6,2,0,0,1,'2020-03-22 12:10:40','2020-03-22 12:14:58',NULL);
ALTER TABLE `pinecms_download` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_link` WRITE;
ALTER TABLE `pinecms_link` DISABLE KEYS;
INSERT INTO `pinecms_link` (`linkid`, `linktype`, `name`, `url`, `logo`, `introduce`, `listorder`, `passed`, `addtime`) VALUES 
	(5,0,'百度','https://www.baidu.com','https://www.baidu.com/img/bd_logo1.png?where=super','',1,1,'2020-02-29 21:19:40'),
	(6,0,'新浪','http://www.baidu.com','https://i1.sinaimg.cn/dy/deco/2013/0329/logo/LOGO_1x.png','',2,1,'2020-02-29 21:19:30');
ALTER TABLE `pinecms_link` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_log` WRITE;
ALTER TABLE `pinecms_log` DISABLE KEYS;
ALTER TABLE `pinecms_log` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_member` WRITE;
ALTER TABLE `pinecms_member` DISABLE KEYS;
INSERT INTO `pinecms_member` (`id`, `account`, `password`, `avatar`, `nickname`, `integral`, `sale_integral`, `draw_account`, `telphone`, `qq`, `description`, `created_at`, `updated_at`, `email`, `enabled`, `verify_token`) VALUES 
...
ALTER TABLE `pinecms_member` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_menu` WRITE;
ALTER TABLE `pinecms_menu` DISABLE KEYS;
INSERT INTO `pinecms_menu` (`id`, `name`, `parentid`, `c`, `a`, `data`, `is_system`, `listorder`, `display`) VALUES 
	(1,'我的面板',0,'admin','public-top','',1,1,'1'),
	(3,'内容管理',1,'content','top','',0,2,'1'),
	...
	(9,'系统设置',1,'setting','left','',0,2,'1'),
	(10,'站点设置',9,'setting','site','',0,1,'1'),
	(11,'管理员设置',1,'admin','left','',0,4,'1'),
	(12,'管理员管理',11,'admin','memberlist','',0,1,'1'),
	(13,'角色管理',11,'admin','rolelist','',0,2,'1'),
	(14,'日志管理',1,'system','loglist','',0,1,'1'),
	(15,'操作日志',14,'system','loglist','',0,1,'1'),
	...
	(34,'发布管理',3,'content','right','',0,0,'0'),
	(35,'内容管理',36,'content','index','',0,0,'1'),
	(36,'栏目管理',3,'category','list','',0,0,'1'),
	...
	(55,'会员管理',1,'user','list','',0,5,'0'),
	(56,'会员列表',55,'user','list','',0,0,'1'),
	(57,'会员信息',56,'user','info','',0,0,'1'),
	(58,'微信管理',1,'wechat','userlist','',0,7,'0'),
	...
	(73,'数据库管理',1,'database','manager','',0,3,'1'),
	...
	(79,'资源管理',1,'assets-manager','list','',0,3,'1'),
...
INSERT INTO `pinecms_setting` (`key`, `value`, `group`, `default`, `form_name`, `editor`, `listorder`) VALUES 
	...
	('SITE_KEYWORDS','pine,pincms,gocms,cms,模板化框架','前台设置',NULL,'关键字','text',2),
	('SITE_DESCRIPTION','pincms一个go语言的模板化CMS，支持类dedecms式的标签化调用。可以快速开发出企业网站，支持自定义文档模型','前台设置',NULL,'描述','text',3),
	('SITE_TITLE','pincms一个go语言的模板化CMS','前台设置',NULL,'站点标题','text',1),
	...
	('UPLOAD_DATABASE_PASS','123456','存储配置','','备份数据库密码','text',24);
ALTER TABLE `pinecms_setting` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_wechat_member` WRITE;
ALTER TABLE `pinecms_wechat_member` DISABLE KEYS;
ALTER TABLE `pinecms_wechat_member` ENABLE KEYS;
UNLOCK TABLES;


LOCK TABLES `pinecms_wechat_message_log` WRITE;
ALTER TABLE `pinecms_wechat_message_log` DISABLE KEYS;
ALTER TABLE `pinecms_wechat_message_log` ENABLE KEYS;
UNLOCK TABLES;
