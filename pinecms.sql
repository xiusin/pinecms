...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='系统内置模型表';
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='内容分类表';
...
INSERT INTO `pinecms_document_model` (`id`, `name`, `table`, `enabled`, `model_type`, `fe_tpl_index`, `fe_tpl_list`, `fe_tpl_detail`, `deleted_at`, `field_show_in_list`, `formatters`, `execed`) VALUES 
	(1,'普通文章','articles',1,1,'resources/views/frontend/index.jet','','',NULL,'{"author":{"show":true,"search":0,"formatter":""},"content":{"show":false,"search":0,"formatter":""},"description":{"show":false,"search":0,"formatter":""},"from_url":{"show":true,"search":0,"formatter":""},"keywords":{"show":false,"search":0,"formatter":""},"pubtime":{"show":true,"search":0,"formatter":""},"tags":{"show":false,"search":2,"formatter":""},"thumb":{"show":false,"search":0,"formatter":""},"title":{"show":true,"search":1,"formatter":""}}','',0);
...
INSERT INTO `pinecms_document_model_dsl` (`id`, `mid`, `form_name`, `table_field`, `html`, `required`, `datasource`, `required_tips`, `validator`, `deleted_at`, `field_type`, `default`) VALUES 
	(29,1,'文章标题','title','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(30,1,'TAG标签','tags','<tags />',0,'','','',NULL,15,''),
	(31,1,'缩略图','thumb','<images />',0,'','','',NULL,11,''),
	(32,1,'文章来源','from_url','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(33,1,'作者','author','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(34,1,'关键字','keywords','<input class="easyui-textbox" {{attr}} value="{{value}}" style="width:300px">',0,'','','',NULL,1,''),
	(35,1,'内容摘要','description','<input class="easyui-textbox" {{attr}} value="{{value}}" style="height:80px; width: 300px;"  multiline />',0,'','','',NULL,2,''),
	(36,1,'文章内容','content','<editor />',1,'','','',NULL,3,''),
	(37,1,'发布时间','pubtime','<input class="easyui-datetimebox" style="width:300px" value="{{value}}" {{attr}} />',0,'','','',NULL,14,'');
...
INSERT INTO `pinecms_menu` (`id`, `name`, `parentid`, `c`, `a`, `data`, `is_system`, `listorder`, `display`) VALUES 
	...
	(55,'会员管理',1,'user','list','',0,5,'1'),
	(56,'会员列表',55,'user','list','',0,0,'1'),
	(57,'会员信息',56,'user','info','',0,0,'1'),
	(58,'微信管理',1,'wechat','userlist','',0,7,'1'),
