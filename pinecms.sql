...
-- ----------------------------
BEGIN;
INSERT INTO `pinecms_admin` VALUES (1, 'admin', '5736a2a40f752bf2e82953702d25075b', 1, 'qmRlFL', '127.0.0.1', 1474291850, 'chenchengbin92111@gmail.com2', 'mirchen.com1');
...
INSERT INTO `pinecms_admin_role` VALUES (9, 'test11', 'test11111111111', 0, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pinecms_document_model_dsl` VALUES (29, 1, '文章标题', 'title', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (30, 1, 'TAG标签', 'tags', '<tags />', 0, '', '', '', NULL, 15, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (31, 1, '缩略图', 'thumb', '<images />', 0, '', '', '', NULL, 11, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (32, 1, '文章来源', 'from_url', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (33, 1, '作者', 'author', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (34, 1, '关键字', 'keywords', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"width:300px\">', 0, '', '', '', NULL, 1, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (35, 1, '内容摘要', 'description', '<input class=\"easyui-textbox\" {{attr}} value=\"{{value}}\" style=\"height:80px; width: 300px;\"  multiline />', 0, '', '', '', NULL, 2, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (36, 1, '文章内容', 'content', '<editor />', 1, '', '', '', NULL, 3, '');
INSERT INTO `pinecms_document_model_dsl` VALUES (37, 1, '发布时间', 'pubtime', '<input class=\"easyui-datetimebox\" style=\"width:300px\" value=\"{{value}}\" {{attr}} />', 0, '', '', '', NULL, 14, '');
COMMIT;
...
INSERT INTO `pinecms_document_model_field` VALUES (4, '附件', 'varshar', '前端表现为input[file]类型,可以上传并且返回一个相对地址', '<input class=\"easyui-filebox\" value=\"{{value}}\" style=\"width:300px\">');
